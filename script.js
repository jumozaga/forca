const palavras = ["java", "react", "node", "python", "php"," front","back","família"];
...
function adicionarPalavra(){
    let palavra = prompt("Digite a nova palavra");
    
    if (palavras.includes(palavra)){
       mostrarAvisoPalavraExiste();
       console.log("Existe")
    }else {
...
function mostrarAvisoPalavraExiste() {
    const aviso = document.querySelector(".palavraexiste");
